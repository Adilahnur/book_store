...
<?php 
if(isset($_GET['id'])){
	$qry = $conn->query("SELECT * FROM stationery where id = ".$_GET['id']);
...
<div class="container-fluid">
	<form action="" id="manage-stationery">
			<input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
		<div class="col-lg-12">
					<b class="text-muted">Stationery Data</b>
			<div class="row">
				<div class="col-md-6 border-right">
					<div class="form-group">
						<label class="label control-label">Item</label>
						<input type="text" class="form-control form-control-sm w-100" name="item" required="" value="<?php echo isset($item) ? $item : '' ?>">
					</div>
				<div class="form-group">
