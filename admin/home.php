                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 p2">
                               ...
                               <div class="col-md-4 p2">
                            	<div class="card bg-light">
	                            	<div class="card-body">
		                                <span class="float-right summary_icon"> <i class="fa fa-pen-alt text-muted "></i></span>
		                                <h4><b>
		                                    <?php echo $conn->query("SELECT * FROM stationery")->num_rows ?>
		                                </b></h4>
		                                <p><b>Total Stationery</b></p>
	                                </div>
                                </div>
                            </div>
                        </div>
